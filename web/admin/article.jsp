			...
			cm: new
				...
				({
					...
					columns: [
						...
						{
							header: "分类",
							dataIndex: "articleCategory_name",
							width: 100
						},
						{
							header: "标题",
						...
						},
						{
							...
							renderer: function(value, metaData, record, rowIndex, colIndex, store) {
								return value ? '<a href="<c:url value="" />' + value + '" target="_blank" class="external" title="浏览"></a>' : '';
							},
							width: 60
						},
						{
 ...
 */
	...
	var _form = new Ext.form.FormPanel({
		...
		items: [
			...
			{
				id: "form-combo-articlecategory",
				fieldLabel: '<span style="color: red;">*</span> 分类',
				xtype: "combo",
				name: "articleCategoryId",
				hiddenName: "articleCategoryId",
				allowBlank: false,
				editable: false,
				forceSelection: true,
				lazyRender: true,
				...
				store: {
					url: "action/do_articlecategory.jsp", // 自定义
					autoDestroy: true,
					//autoLoad: true,
					baseParams: {
						// 自定义
			...
			{
				fieldLabel: '<span style="color: red;">*</span> 内容',
				xtype: "htmleditor",
				name: "content",
				enableFont: false,
			...
			items: [
				// 自定义
				{
					...
					items: [
						...
						{
							html: '<img src="' + that.preview.src + '" alt="" id="' + that.preview.id + '" style="border: 1px solid silver; width: 86px;" />',
							style: {
								"margin-top": "4px"
							}
						}
